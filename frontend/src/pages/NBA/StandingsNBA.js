...
function StandingsNBA() {
  ...
  useEffect(() => {
    fetch('http://localhost:8000/api/nba/seasons/')
      .then((res) => res.json())
      .then((data) => {
  ...
  useEffect(() => {
    ...
    fetch(`http://127.0.0.1:8000/api/nba/standings/?${params.toString()}`)
      .then((res) => res.json())
