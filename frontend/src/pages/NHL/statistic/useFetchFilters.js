...
export const useFetchFilters = ({ filters, activeFilters, setTeams, setPlayers, setOpponents, setSeasons, setStages, setHomeAway }) => {
  useEffect(() => {
    if (activeFilters.includes("team_id")) {
      fetch("http://127.0.0.1:8000/api/nhl/teams_by_filters/", {
        method: "POST",
  ...
  useEffect(() => {
    if (activeFilters.includes("player_id")) {
      fetch("http://127.0.0.1:8000/api/nhl/players_by_filters/", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify(filters),
      })
  ...
  useEffect(() => {
    if (activeFilters.includes("opponent_id")) {
      fetch("http://127.0.0.1:8000/api/nhl/opponents_by_filters/", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify(filters),
      })
  ...
  useEffect(() => {
    if (activeFilters.includes("season")) {
      fetch("http://127.0.0.1:8000/api/nhl/seasons_by_filters/", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify(filters),
      })
  ...
  useEffect(() => {
    if (activeFilters.includes("homeaway")) {
      fetch("http://127.0.0.1:8000/api/nhl/homeaway_by_filters/", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify(filters),
      })
  ...
  useEffect(() => {
    if (activeFilters.includes("stage")) {
      fetch("http://127.0.0.1:8000/api/nhl/stages_by_filters/", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify(filters),
      })
