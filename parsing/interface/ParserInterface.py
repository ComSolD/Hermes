...
"}")
        ...
        self.ui.OddsWidget = QtWidgets.QWidget(self.ui.MainWidget)
        self.ui.OddsWidget.setGeometry(QtCore.QRect(-50, 600, 719, 50))
        self.ui.OddsWidget.setMinimumSize(QtCore.QSize(0, 50))
        self.ui.OddsWidget.setMaximumSize(QtCore.QSize(16777215, 50))
        self.ui.OddsWidget.setObjectName("OddsWidget")
        self.ui.horizontalLayout = QtWidgets.QHBoxLayout(self.ui.OddsWidget)
        self.ui.horizontalLayout.setContentsMargins(0, 0, 0, 0)
        self.ui.horizontalLayout.setObjectName("horizontalLayout")

        self.ui.OddsCheckBox = QtWidgets.QCheckBox(self.ui.OddsWidget)
        self.ui.OddsCheckBox.setStyleSheet("""QCheckBox{
font-size: 28px;
color: #CCCCCC;
}
QCheckBox::indicator {
...
""")
        self.ui.OddsCheckBox.setObjectName("OddsCheckBox")
        self.ui.horizontalLayout.addWidget(self.ui.OddsCheckBox)


        self.ui.CurrentSeasonCheckBox = QtWidgets.QCheckBox(self.ui.GetDataWidget)
        self.ui.CurrentSeasonCheckBox.setStyleSheet("""QCheckBox{
font-size: 28px;
color: #CCCCCC;
}
QCheckBox::indicator {
...
""")
        self.ui.CurrentSeasonCheckBox.setObjectName("CurrentSeasonCheckBox")
        self.ui.CurrentSeasonCheckBox.setVisible(False)
        self.ui.horizontalLayout.addWidget(self.ui.CurrentSeasonCheckBox)


        self.ui.GetOddsCheckBox = QtWidgets.QCheckBox(self.ui.GetDataWidget)
        self.ui.GetOddsCheckBox.setStyleSheet("""QCheckBox{
font-size: 28px;
color: #CCCCCC;
}
QCheckBox::indicator {
...
""")
        self.ui.GetOddsCheckBox.setObjectName("GetOddsCheckBox")
        self.ui.GetOddsCheckBox.setVisible(False)
        self.ui.horizontalLayout.addWidget(self.ui.GetOddsCheckBox)


        self.ui.DateOddsCheckBox = QtWidgets.QCheckBox(self.ui.GetDataWidget)
        self.ui.DateOddsCheckBox.setStyleSheet("""QCheckBox{
font-size: 28px;
color: #CCCCCC;
}
QCheckBox::indicator {
...
""")
        self.ui.DateOddsCheckBox.setObjectName("DateOddsCheckBox")
        self.ui.DateOddsCheckBox.setVisible(False)
        self.ui.horizontalLayout.addWidget(self.ui.DateOddsCheckBox)
...
"}")
        ...
        self.ui.OddsCheckBox.setText(_translate("MainWindow", "Ставки"))

        self.ui.CurrentSeasonCheckBox.setText(_translate("MainWindow", "Текущий сезон"))

        self.ui.GetOddsCheckBox.setText(_translate("MainWindow", "Собрать"))
        ...
        self.MainWidget.addWidget(self.ui.OddsWidget)
